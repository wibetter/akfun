...
![image](https://user-images.githubusercontent.com/11958920/124530964-11a17800-de40-11eb-8353-bbeb44b85c33.png)
关键字：协作开发、开发流程规范
...
假如没有一套完善的交通规则（红绿灯、交通法律法规等各类规章制度），各个十字路口就会拥堵不堪，交通事故也会频发不断，最后大家都很难顺利的到达目的地（难于顺利的完成开发任务）。
...
项目负责人仅分解颗粒度较大的任务模块，然后分配给各开发成员，由开发成员再细分任务模块，建颗粒度更小的issue，开发前项目负责人过审一遍，确保issue的合理性。不管是分配模式还是领取模式，尽可能提前划分好各开发成员的职责范围。
